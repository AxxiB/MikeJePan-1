(function () {
    ...
    function extend() {
        ...
        bot.commands.instaCommand = {
          command: 'insta',  // The command to be called. With the standard command literal this would be: !bacon
          ...
          functionality: function (chat, cmd) {
            ...
            if (!bot.commands.executable(this.rank, chat)) return void (0);
              ...
              API.sendChat("/me @" + user + " https://www.instagram.com/mikejepan/");
            }
          }
        };
